-- Final Working Sample Data Script for Bus Tickets System
...
-- =====================================================
-- 2. CREATE SAMPLE USERS FIRST (IDs 1-5)
-- =====================================================
...
-- =====================================================
-- 5. SCHEDULES DATA (IDs 1-15) - USING CORRECT BUS IDs 1-10
-- =====================================================
...
-- =====================================================
-- 6. BOOKINGS DATA (IDs 1-10) - USING CORRECT USER IDs 1-5
-- =====================================================
...
-- SUMMARY
-- =====================================================
-- Users: 5 sample users including admin (IDs 1-5)
...
-- 2. Execute this script: psql -U postgres -d bus_tickets_db -f sql/00_all_sample_data_final_working.sql
