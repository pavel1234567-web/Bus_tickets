-- Complete Sample Data Script for Bus Tickets System (FIXED VERSION)
...
('NO6789', 'luxury', 28, 2, true, true, true, 'First class bus with concierge service', true, NOW()),
...
-- Reset sequences
ALTER SEQUENCE auth_user_id_seq RESTART WITH 6;
...
-- Buses: 25 buses (standard, comfort, luxury classes) - FIXED DUPLICATES
-- Schedules: 37 schedules with various departure times
-- Tickets: 60+ tickets with different statuses (available, booked, paid)
-- Bookings: 17 bookings with various customer types - FIXED USER REFERENCES
-- Payments: 17 payments with different methods and statuses
-- Users: 5 sample users including admin - FIXED NULL VALUES

-- =====================================================
-- USAGE INSTRUCTIONS
-- =====================================================
-- 1. Run migrations first: python manage.py migrate
-- 2. Execute this script: psql -d bus_tickets_db -f sql/00_all_sample_data_fixed.sql
